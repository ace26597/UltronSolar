        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4 pt-4 border-t border-white/5">
              ...
              <a href="https://www.instagram.com/ultronpowersystems/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-solar-orange hover:text-white transition-all duration-300 group">
