...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-20 bg-futuristic-bg-primary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <div className="mt-4 flex justify-center items-center space-x-2">
            <span className="text-futuristic-accent-primary text-xl font-orbitron font-bold">4.9/5</span>
            <div className="flex text-futuristic-accent-primary">
              {[...Array(5)].map((_, i) => (
                <span key={i}>★</span>
              ))}
            </div>
            <span className="text-futuristic-text-muted text-sm font-montserrat">(based on Google Reviews)</span>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="overflow-hidden px-4 -mx-4">
            ...
            >
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="glass p-8 rounded-none shadow-lg border border-futuristic-accent-primary/10 text-center h-full flex flex-col relative">
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-futuristic-accent-primary text-futuristic-bg-primary w-12 h-12 rounded-none flex items-center justify-center text-xl font-orbitron font-bold shadow-md border-2 border-futuristic-accent-primary">
                      {testimonial.name.charAt(0)}
                    </div>

                    <div className="flex justify-center text-futuristic-accent-primary mb-4 mt-4">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <span key={i} className="text-lg">★</span>
                      ))}
                    </div>

                    <p className="text-futuristic-text-muted mb-6 italic leading-relaxed flex-grow text-sm md:text-base font-montserrat">
                      &quot;{testimonial.content}&quot;
                    </p>

                    <div>
                      <h3 className="text-lg font-bold font-montserrat text-futuristic-text-main">
                        {testimonial.name}
                      </h3>
                      <p className="text-futuristic-accent-primary text-xs font-medium mt-1 font-montserrat">
                        {testimonial.seoInfo}
                      </p>
                    </div>
                  </div>
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 md:-ml-6 glass border border-futuristic-accent-primary/30 p-2 rounded-none shadow-md hover:border-futuristic-accent-primary text-futuristic-accent-primary z-10 hidden md:block"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 -mr-4 md:-mr-6 glass border border-futuristic-accent-primary/30 p-2 rounded-none shadow-md hover:border-futuristic-accent-primary text-futuristic-accent-primary z-10 hidden md:block"
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="inline-flex items-center text-futuristic-text-main hover:text-futuristic-accent-primary font-semibold transition-colors glass px-6 py-3 rounded-none hover:border-futuristic-accent-primary border border-futuristic-accent-primary/30 font-montserrat"
          >
