    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {!isOpen && (
        <button
          ...
          className="bg-solar-red hover:bg-solar-red-dark text-white rounded-full p-4 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 flex items-center justify-center"
      ...
      {isOpen && (
        <div className="bg-white rounded-2xl shadow-2xl w-[380px] h-[600px] flex flex-col border border-gray-200">
          {/* Header */}
          <div className="bg-solar-red text-white p-4 rounded-t-2xl flex justify-between items-center">
            <div className="flex items-center gap-2">
              <h3 className="font-bold text-lg">Chat with Ultron Solar</h3>
            </div>
            <button
          ...
          <div className="flex border-b border-gray-200">
            <button
              ...
              className={`flex-1 py-3 px-4 font-medium transition-colors ${
                activeTab === 'chat'
                  ? 'bg-gray-50 text-solar-red border-b-2 border-solar-red'
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  {messages.length === 0 && (
                    <div className="text-center text-gray-500 mt-8">
                      <p className="mb-4">Hello! How can we help you with solar solutions?</p>
                ...
                <div className="border-t border-gray-200 p-4">
                  ...
                  >
                    <input
                      ...
                      className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-solar-red"
                      disabled={isLoading}
                    />
                    <button
                      type="submit"
                      disabled={isLoading || !inputValue.trim()}
                      className="bg-solar-red text-white px-6 py-2 rounded-lg font-medium hover:bg-solar-red-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Send
                    </button>
                  </form>
