          ...
          <div className="space-y-8">
            <div className="bg-navy-dark text-white rounded-2xl shadow-lg p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="mt-8 pt-8 border-t border-white/10 flex gap-4">
                ...
                <a href="https://www.instagram.com/ultronpowersystems/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="bg-white/10 hover:bg-white/20 p-3 rounded-full transition-colors">
